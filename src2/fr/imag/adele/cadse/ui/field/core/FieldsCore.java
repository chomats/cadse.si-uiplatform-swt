...
import fede.workspace.model.manager.properties.impl.ic.IC_ForCheckedViewer;
...
public class FieldsCore {
	...
	public static DCheckBoxUI createCheckBox(String key, String label, RuningInteractionController ic) {
	...
	public static DBrowserUI createBrowserField(String key, String label, EPosLabel poslabel,
			IC_ForBrowserOrCombo ic, IModelController mc) {
	...
	public static DComboUI createComboBox(String key, String label, EPosLabel poslabel,
			IC_ForBrowserOrCombo ic, IModelController mc, boolean edit) {
		if (mc == null) {
	...
	public static DTextUI createTextField(String key, String label, RuningInteractionController uc) {
	...
	public static DListUI createList(String key, String label, IModelController mc, IC_ForList ic,
			Object... objects) {
